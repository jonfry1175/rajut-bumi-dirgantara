...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-company-primary to-company-dark text-white py-16 relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-company-softblue opacity-5 rounded-full translate-x-1/3 translate-y-1/3"></div>
      <div className="absolute top-1/2 right-1/4 w-32 h-32 bg-company-accent opacity-10 rounded-full"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Tautan Cepat</h3>
            <div className="h-1 w-16 bg-gradient-to-r from-company-softblue to-transparent mb-5 rounded-full"></div>
          ...
          <motion.div variants={itemVariants}>
            <h3 className="text-2xl font-bold mb-4 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">Hubungi Kami</h3>
            <div className="h-1 w-16 bg-gradient-to-r from-company-softblue to-transparent mb-5 rounded-full"></div>
