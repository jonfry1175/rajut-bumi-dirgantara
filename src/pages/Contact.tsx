...
const ContactPage = () => {
  return (
    <>
      <Helmet>
        <title>Kontak PT Bejo Berkat Makmur | inibejo.com</title>
        <link rel="canonical" href="https://inibejo.com/contact" />
        <meta
          name="description"
          content="Hubungi PT Bejo Berkat Makmur untuk konsultasi awal, penawaran kerja sama, atau dukungan teknis terkait solusi TI."
        />
        <meta property="og:title" content="Kontak PT Bejo Berkat Makmur | inibejo.com" />
        <meta
          property="og:description"
          content="Tim PT Bejo Berkat Makmur siap membantu kebutuhan teknologi informasi bisnis Anda."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://inibejo.com/contact" />
        <meta property="og:image" content="https://inibejo.com/logo-bejo.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Kontak PT Bejo Berkat Makmur | inibejo.com" />
        <meta
          name="twitter:description"
          content="Sampaikan kebutuhan transformasi digital Anda melalui inibejo.com."
        />
